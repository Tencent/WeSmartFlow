...
| 页面     | 路由         | 功能                                   |
| -------- | ------------ | -------------------------------------- |
| 登录     | `/login`     | 邮箱验证码登录，新用户自动注册         |
| 今日学习 | `/`          | 个性化学习计划、学习热力图、待复习节点 |
| AI 辅导  | `/chat`      | 交互式对话学习 + 沉浸式课程生成        |
...
- **SSE 流式对话**：实时展示 AI 回复，支持 Markdown + LaTeX 渲染
- **PDF 知识卡片**：在线预览 Agent 生成的 Beamer PDF 课件
